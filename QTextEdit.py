...
from PyQt5.QtWidgets import (QAction, QApplication, QFileDialog, QMainWindow, QMessageBox, QTextEdit, QPushButton, QLineEdit, QMenu, QInputDialog)
...
class MainWindow(QMainWindow):
    ...
    def findText(self):
        ...
        if not self.myeditor.find(word):
